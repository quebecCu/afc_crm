...
class ContactsComponent extends Component   {
	...
	render() {
		return(
			<div>
				<h4>Contact {this.props.idContact}<span className="fa fa-plus-square" onClick={this._addContact}/> <span className="fa fa-minus-square" onClick={this._deleteContact}/></h4>
