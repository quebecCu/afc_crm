...
INSERT INTO public."ENTREPRISE"(idclient, idadresse, idactivite, nom, tel_principal, ext_tel_principal, date_creation) VALUES ((SELECT idclient FROM public."CLIENT" ORDER BY idclient DESC LIMIT 1), (SELECT idadresse FROM public."ADRESSE" ORDER BY idadresse DESC LIMIT 1), NULL, '2330-2029 Québec Inc (Oxybec)', '(819)566-8711', NULL, to_date('2006-01-01', 'YYYY-MM-DD')) ;
...
INSERT INTO public."ENTREPRISE"(idclient, idadresse, idactivite, nom, tel_principal, ext_tel_principal, date_creation) VALUES ((SELECT idclient FROM public."CLIENT" ORDER BY idclient DESC LIMIT 1), (SELECT idadresse FROM public."ADRESSE" ORDER BY idadresse DESC LIMIT 1), NULL, '3102-9648 QC inc. (Simo/Racine)', '(819)347-7697', NULL, to_date('2005-01-01', 'YYYY-MM-DD')) ;
...
INSERT INTO public."ENTREPRISE"(idclient, idadresse, idactivite, nom, tel_principal, ext_tel_principal, date_creation) VALUES ((SELECT idclient FROM public."CLIENT" ORDER BY idclient DESC LIMIT 1), (SELECT idadresse FROM public."ADRESSE" ORDER BY idadresse DESC LIMIT 1), NULL, 'A.B.C. de la Fête', '(819)565-2131', NULL, to_date('1997-01-01', 'YYYY-MM-DD')) ;
...
INSERT INTO public."ENTREPRISE"(idclient, idadresse, idactivite, nom, tel_principal, ext_tel_principal, date_creation) VALUES ((SELECT idclient FROM public."CLIENT" ORDER BY idclient DESC LIMIT 1), (SELECT idadresse FROM public."ADRESSE" ORDER BY idadresse DESC LIMIT 1), NULL, 'Actuel Beauté', '(819)829-9777', NULL, to_date('2006-01-01', 'YYYY-MM-DD')) ;
...
INSERT INTO public."ENTREPRISE"(idclient, idadresse, idactivite, nom, tel_principal, ext_tel_principal, date_creation) VALUES ((SELECT idclient FROM public."CLIENT" ORDER BY idclient DESC LIMIT 1), (SELECT idadresse FROM public."ADRESSE" ORDER BY idadresse DESC LIMIT 1), NULL, 'Acuponcture Suzanne Giguère', '(819)821-4163', NULL, to_date('1999-01-01', 'YYYY-MM-DD')) ;
...
INSERT INTO public."ENTREPRISE"(idclient, idadresse, idactivite, nom, tel_principal, ext_tel_principal, date_creation) VALUES ((SELECT idclient FROM public."CLIENT" ORDER BY idclient DESC LIMIT 1), (SELECT idadresse FROM public."ADRESSE" ORDER BY idadresse DESC LIMIT 1), NULL, 'Adawati', '(819)843-8480', NULL, to_date('2002-01-01', 'YYYY-MM-DD')) ;
...
INSERT INTO public."ENTREPRISE"(idclient, idadresse, idactivite, nom, tel_principal, ext_tel_principal, date_creation) VALUES ((SELECT idclient FROM public."CLIENT" ORDER BY idclient DESC LIMIT 1), (SELECT idadresse FROM public."ADRESSE" ORDER BY idadresse DESC LIMIT 1), NULL, 'Alarme Multi Protec Inc', '(819)868-3807', NULL, to_date('2006-01-01', 'YYYY-MM-DD')) ;
...
INSERT INTO public."ENTREPRISE"(idclient, idadresse, idactivite, nom, tel_principal, ext_tel_principal, date_creation) VALUES ((SELECT idclient FROM public."CLIENT" ORDER BY idclient DESC LIMIT 1), (SELECT idadresse FROM public."ADRESSE" ORDER BY idadresse DESC LIMIT 1), NULL, 'Aqua Pro-Jet', '(819)868-2720', NULL, to_date('2003-01-01', 'YYYY-MM-DD')) ;
...
INSERT INTO public."ENTREPRISE"(idclient, idadresse, idactivite, nom, tel_principal, ext_tel_principal, date_creation) VALUES ((SELECT idclient FROM public."CLIENT" ORDER BY idclient DESC LIMIT 1), (SELECT idadresse FROM public."ADRESSE" ORDER BY idadresse DESC LIMIT 1), NULL, 'Arboriculture Carrier', '(819)839-1328', NULL, to_date('2005-01-01', 'YYYY-MM-DD')) ;
...
INSERT INTO public."ENTREPRISE"(idclient, idadresse, idactivite, nom, tel_principal, ext_tel_principal, date_creation) VALUES ((SELECT idclient FROM public."CLIENT" ORDER BY idclient DESC LIMIT 1), (SELECT idadresse FROM public."ADRESSE" ORDER BY idadresse DESC LIMIT 1), NULL, 'Artisans Magog', '(819)843-4872', NULL, to_date('1999-01-01', 'YYYY-MM-DD')) ;
...
INSERT INTO public."ENTREPRISE"(idclient, idadresse, idactivite, nom, tel_principal, ext_tel_principal, date_creation) VALUES ((SELECT idclient FROM public."CLIENT" ORDER BY idclient DESC LIMIT 1), (SELECT idadresse FROM public."ADRESSE" ORDER BY idadresse DESC LIMIT 1), NULL, 'Ass. Régionale soccer Estrie', '(819)864-1322', NULL, to_date('2005-01-01', 'YYYY-MM-DD')) ;
...
INSERT INTO public."ENTREPRISE"(idclient, idadresse, idactivite, nom, tel_principal, ext_tel_principal, date_creation) VALUES ((SELECT idclient FROM public."CLIENT" ORDER BY idclient DESC LIMIT 1), (SELECT idadresse FROM public."ADRESSE" ORDER BY idadresse DESC LIMIT 1), NULL, 'Association Action Plus L.G.S.', '(819)770-2018', '20', to_date('2005-01-01', 'YYYY-MM-DD')) ;
...
INSERT INTO public."ENTREPRISE"(idclient, idadresse, idactivite, nom, tel_principal, ext_tel_principal, date_creation) VALUES ((SELECT idclient FROM public."CLIENT" ORDER BY idclient DESC LIMIT 1), (SELECT idadresse FROM public."ADRESSE" ORDER BY idadresse DESC LIMIT 1), NULL, 'Aubaines Plus Luma', '(819)563-6939', NULL, to_date('2001-01-01', 'YYYY-MM-DD')) ;
...
INSERT INTO public."ENTREPRISE"(idclient, idadresse, idactivite, nom, tel_principal, ext_tel_principal, date_creation) VALUES ((SELECT idclient FROM public."CLIENT" ORDER BY idclient DESC LIMIT 1), (SELECT idadresse FROM public."ADRESSE" ORDER BY idadresse DESC LIMIT 1), NULL, 'Auto Électrique Michel inc.', '(819)846-4710', NULL, to_date('1997-01-01', 'YYYY-MM-DD')) ;
